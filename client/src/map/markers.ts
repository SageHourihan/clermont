...
function createPopupContent(event: Event): string {
...
export function createEventMarker(event: Event): L.Marker {
...
export function buildMarkerLayer(events: Event[]): L.LayerGroup {
