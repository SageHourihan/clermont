...
function renderRelatedRow(event) {
...
// ── Public API ────────────────────────────────────────────
export function setFocusedEvent(event) {
    _focusedEvent = event;
}
export function getFocusedEvent() {
    return _focusedEvent;
}
export function initFocused(overlayId, leafletId, getAllEvents) {
    _overlayId = overlayId;
    _leafletId = leafletId;
    _getAllEvents = getAllEvents;
}
export function renderFocused(containerId) {
