...
export function getCurrentDetailEvent(): Event | null {
  return _currentEvent
}

export function openDetail(event: Event): void {
  _currentEvent = event
...
export function flyCurrentToMap(): void {
